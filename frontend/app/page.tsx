    ...
    <div className="space-y-20">
      ...
      <section className="space-y-12">
        <div className="text-center space-y-4">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white">Why Choose PathWise?</h2>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          <Card className="border-0 bg-white dark:bg-slate-800 shadow-lg">
            <CardContent className="pt-6">
              ...
              <p className="text-slate-600 dark:text-slate-300 mb-4">
                "PathWise transformed my learning experience. The micro-lessons are perfect for my busy schedule!"
              </p>
      ...
      <section className="text-center space-y-8 py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 rounded-3xl text-white mx-4">
        <div className="space-y-4">
          ...
          <p className="text-xl opacity-90 max-w-2xl mx-auto">
            Join thousands of professionals who are already accelerating their growth with PathWise.
          </p>
        </div>
